        ...
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-5 max-w-sm font-display text-3xl leading-[1.05] text-white/90">
              Une pause de douceur et d’apaisement, au Faou.
            </p>
          ...
          <div>
            ...
            <ul className="mt-5 text-sm font-light text-white/75">
              ...
              <li>
                <a href={URLS.avancee} className="block py-1.5 transition-colors hover:text-amber">
                  Réflexologie avancée
                </a>
              </li>
              <li>
