...
import { SITE, URLS, type Route } from '../lib/site';
...
const ENTREES: Entree[] = [
  { label: 'Bienvenue', href: URLS.accueil },
  {
    label: 'Les soins',
    sous: [
      { label: 'Réflexologie plantaire', href: URLS.reflexologie },
      { label: 'Fleurs de Bach', href: URLS.bach },
      { label: 'Réflexologie avancée', href: URLS.avancee },
    ],
  },
...
const SOUS_ROUTES: Route[] = ['reflexologie', 'bach', 'avancee'];
