...
import { APERCU_TARIFS, prixDuSoin, SITE, SOINS, T, TARIFS, URLS, VIDEOS } from '../lib/site';
        ...
        cartes={
          <>
            <CarteVerre
              ...
              legende={`${SITE.adresse.rue}, ${SITE.adresse.codePostal} ${SITE.adresse.ville}`}
            />
            <CarteVerre
          ...
          <Reveal delai={160}>
            <figure className="relative overflow-hidden rounded-[1.5rem]">
              <img
                ...
                alt="Matthieu Chrétien en séance de réflexologie, au cabinet du Faou"
                width={575}
                height={1024}
                loading="lazy"
                decoding="async"
